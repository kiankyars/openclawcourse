...
| Module | Success criterion (learner can …) |
|--------|-----------------------------------|
...
Instructor should keep each module within its Total; use Buffer for Q&A or catch-up.
...
- Node ≥22.
- Docker (optional but recommended for Module 6).
...
Module READMEs link to specific doc pages; this spec does not duplicate them.
